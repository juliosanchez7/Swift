...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func savePhoto(){
        //Save Image with UIImageWriteToSavedPhotosAlbum function
        //https://www.hackingwithswift.com/books/ios-swiftui/saving-the-filtered-image-using-uiimagewritetosavedphotosalbum
        UIImageWriteToSavedPhotosAlbum(imageView.image!, self, #selector(saveError), nil)
